...
namespace Perfor.Lib.Cryptography
{
    ...
    public class AESEncrypt : Aes
    {
         ...
         * */
        public AESEncrypt(bool useDefaultKey = false)
        {
         ...
         * */
        public AESEncrypt(byte[] key, byte[] iv)
        {
        ...
        {
            ICryptoTransform transform =Aes.Create().CreateDecryptor(rgbKey, rgbIV);
        ...
        {
            ICryptoTransform transform = Aes.Create().CreateEncryptor(rgbKey, rgbIV);
